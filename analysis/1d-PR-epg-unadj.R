...
dW=d[,c("block","tr","clusterid","alepg","hwepg","ttepg","logalepg",
        "loghwepg","logttepg",W)]
...
est.al.h1.ari=apply(matrix(trlist), 1,function(x) washb_tmle(Y=dW$alepg,tr=dW$tr,
   pair=dW$block, id=dW$block,FECR="arithmetic",
...
al_fecr_ari_h1_unadj_j=format.epg.tmle(est.al.h1.ari)
hw_fecr_ari_h1_unadj_j=format.epg.tmle(est.hw.h1.ari)
tt_fecr_ari_h1_unadj_j=format.epg.tmle(est.tt.h1.ari)

rownames(al_fecr_ari_h1_unadj_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(hw_fecr_ari_h1_unadj_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(tt_fecr_ari_h1_unadj_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")

# geometric means --------------------------
est.al.h1.geo=apply(matrix(trlist), 1,function(x) washb_tmle(Y=dW$logalepg,tr=dW$tr,
   pair=dW$block, id=dW$block,FECR="geometric",
   family="gaussian",contrast=c("Control",x),Q.SL.library=SL.library,
   g.SL.library=SL.library, pval=0.2, seed=12345, print=TRUE))
...
al_fecr_geo_h1_unadj_j=format.epg.tmle(est.al.h1.geo)
hw_fecr_geo_h1_unadj_j=format.epg.tmle(est.hw.h1.geo)
tt_fecr_geo_h1_unadj_j=format.epg.tmle(est.tt.h1.geo)

rownames(al_fecr_geo_h1_unadj_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(hw_fecr_geo_h1_unadj_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(tt_fecr_geo_h1_unadj_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
...
al_fecr_ari_h2_unadj_j=format.epg.tmle(est.al.h2.ari)
hw_fecr_ari_h2_unadj_j=format.epg.tmle(est.hw.h2.ari)
tt_fecr_ari_h2_unadj_j=format.epg.tmle(est.tt.h2.ari)
...
al_fecr_ari_h3_unadj_j=format.epg.tmle(est.al.h3.ari)
hw_fecr_ari_h3_unadj_j=format.epg.tmle(est.hw.h3.ari)
tt_fecr_ari_h3_unadj_j=format.epg.tmle(est.tt.h3.ari)

rownames(al_fecr_ari_h3_unadj_j)=c("Nutrition + WSH vs WSH","Nutrition + WSH vs Nutrition")
rownames(hw_fecr_ari_h3_unadj_j)=c("Nutrition + WSH vs WSH","Nutrition + WSH vs Nutrition")
rownames(tt_fecr_ari_h3_unadj_j)=c("Nutrition + WSH vs WSH","Nutrition + WSH vs Nutrition")
...
al_fecr_geo_h3_unadj_j=format.epg.tmle(est.al.h3.geo)
hw_fecr_geo_h3_unadj_j=format.epg.tmle(est.hw.h3.geo)
tt_fecr_geo_h3_unadj_j=format.epg.tmle(est.tt.h3.geo)

rownames(al_fecr_geo_h3_unadj_j)=c("Nutrition + WSH vs WSH","Nutrition + WSH vs Nutrition")
rownames(hw_fecr_geo_h3_unadj_j)=c("Nutrition + WSH vs WSH","Nutrition + WSH vs Nutrition")
rownames(tt_fecr_geo_h3_unadj_j)=c("Nutrition + WSH vs WSH","Nutrition + WSH vs Nutrition")

#----------------------------------------------
# save objects
#----------------------------------------------

save(al_fecr_ari_h1_unadj_j,hw_fecr_ari_h1_unadj_j,tt_fecr_ari_h1_unadj_j,
