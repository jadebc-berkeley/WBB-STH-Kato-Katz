...
al_fecr_geo_h2_adj_j=format.epg.tmle(est.al.h2.geo)
hw_fecr_geo_h2_adj_j=format.epg.tmle(est.hw.h2.geo)
tt_fecr_geo_h2_adj_j=format.epg.tmle(est.tt.h2.geo)

rownames(al_fecr_geo_h2_adj_j)=c("WSH vs Water","WSH vs Sanitation","WSH vs Handwashing")
rownames(hw_fecr_geo_h2_adj_j)=c("WSH vs Water","WSH vs Sanitation","WSH vs Handwashing")
rownames(tt_fecr_geo_h2_adj_j)=c("WSH vs Water","WSH vs Sanitation","WSH vs Handwashing")
