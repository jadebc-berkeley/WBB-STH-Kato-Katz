...
al_fecr_ari_h1_unadj_def1_j=format.epg.tmle(est.al.h1.def1.ari)
hw_fecr_ari_h1_unadj_def1_j=format.epg.tmle(est.hw.h1.def1.ari)
tt_fecr_ari_h1_unadj_def1_j=format.epg.tmle(est.tt.h1.def1.ari)

rownames(al_fecr_ari_h1_unadj_def1_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(hw_fecr_ari_h1_unadj_def1_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(tt_fecr_ari_h1_unadj_def1_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
...
al_fecr_geo_h1_unadj_def1_j=format.epg.tmle(est.al.h1.def1.geo)
hw_fecr_geo_h1_unadj_def1_j=format.epg.tmle(est.hw.h1.def1.geo)
tt_fecr_geo_h1_unadj_def1_j=format.epg.tmle(est.tt.h1.def1.geo)

rownames(al_fecr_geo_h1_unadj_def1_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(hw_fecr_geo_h1_unadj_def1_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                             "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(tt_fecr_geo_h1_unadj_def1_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                             "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")  
...
al_fecr_ari_h1_unadj_def0_j=format.epg.tmle(est.al.h1.def0.ari)
hw_fecr_ari_h1_unadj_def0_j=format.epg.tmle(est.hw.h1.def0.ari)
tt_fecr_ari_h1_unadj_def0_j=format.epg.tmle(est.tt.h1.def0.ari)

rownames(al_fecr_ari_h1_unadj_def0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(hw_fecr_ari_h1_unadj_def0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(tt_fecr_ari_h1_unadj_def0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
...
al_fecr_geo_h1_unadj_def0_j=format.epg.tmle(est.al.h1.def0.geo)
hw_fecr_geo_h1_unadj_def0_j=format.epg.tmle(est.hw.h1.def0.geo)
tt_fecr_geo_h1_unadj_def0_j=format.epg.tmle(est.tt.h1.def0.geo)

rownames(al_fecr_geo_h1_unadj_def0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(hw_fecr_geo_h1_unadj_def0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                             "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(tt_fecr_geo_h1_unadj_def0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                             "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")  
...
save(al_fecr_ari_h1_unadj_def1_j,hw_fecr_ari_h1_unadj_def1_j,tt_fecr_ari_h1_unadj_def1_j,
     al_fecr_geo_h1_unadj_def1_j,hw_fecr_geo_h1_unadj_def1_j,tt_fecr_geo_h1_unadj_def1_j,

     al_fecr_ari_h1_unadj_def0_j,hw_fecr_ari_h1_unadj_def0_j,tt_fecr_ari_h1_unadj_def0_j,
     al_fecr_geo_h1_unadj_def0_j,hw_fecr_geo_h1_unadj_def0_j,tt_fecr_geo_h1_unadj_def0_j,
     
     file="~/Box Sync/WASHB Parasites/Results/Jade/sth_pr_epg_unadj_defday.RData")
