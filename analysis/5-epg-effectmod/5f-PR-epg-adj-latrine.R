...
al_fecr_h1_ari_lat1_j=format.epg.tmle(est.al.h1.lat1.ari)
hw_fecr_h1_ari_lat1_j=format.epg.tmle(est.hw.h1.lat1.ari)
tt_fecr_h1_ari_lat1_j=format.epg.tmle(est.tt.h1.lat1.ari)

rownames(al_fecr_h1_ari_lat1_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(hw_fecr_h1_ari_lat1_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(tt_fecr_h1_ari_lat1_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
...
al_fecr_h1_geo_lat1_j=format.epg.tmle(est.al.h1.lat1.geo)
hw_fecr_h1_geo_lat1_j=format.epg.tmle(est.hw.h1.lat1.geo)
tt_fecr_h1_geo_lat1_j=format.epg.tmle(est.tt.h1.lat1.geo)

rownames(al_fecr_h1_geo_lat1_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(hw_fecr_h1_geo_lat1_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                             "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(tt_fecr_h1_geo_lat1_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                             "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")  
...
al_fecr_h1_ari_lat0_j=format.epg.tmle(est.al.h1.lat0.ari)
hw_fecr_h1_ari_lat0_j=format.epg.tmle(est.hw.h1.lat0.ari)
tt_fecr_h1_ari_lat0_j=format.epg.tmle(est.tt.h1.lat0.ari)

rownames(al_fecr_h1_ari_lat0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(hw_fecr_h1_ari_lat0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(tt_fecr_h1_ari_lat0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
...
al_fecr_h1_geo_lat0_j=format.epg.tmle(est.al.h1.lat0.geo)
hw_fecr_h1_geo_lat0_j=format.epg.tmle(est.hw.h1.lat0.geo)
tt_fecr_h1_geo_lat0_j=format.epg.tmle(est.tt.h1.lat0.geo)

rownames(al_fecr_h1_geo_lat0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(hw_fecr_h1_geo_lat0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                             "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(tt_fecr_h1_geo_lat0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                             "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")  
...
save(al_fecr_h1_geo_lat1_j,hw_fecr_h1_geo_lat1_j,tt_fecr_h1_geo_lat1_j,
     al_fecr_h1_geo_lat1_j,hw_fecr_h1_geo_lat1_j,tt_fecr_h1_geo_lat1_j,

     al_fecr_h1_ari_lat0_j,hw_fecr_h1_ari_lat0_j,tt_fecr_h1_ari_lat0_j,
     al_fecr_h1_ari_lat0_j,hw_fecr_h1_ari_lat0_j,tt_fecr_h1_ari_lat0_j,
