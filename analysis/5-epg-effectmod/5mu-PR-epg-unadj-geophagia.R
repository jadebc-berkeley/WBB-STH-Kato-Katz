...
est.al.h1.geo1.ari=apply(matrix(trlist), 1,function(x) washb_tmle(Y=geo1$alepg,tr=geo1$tr,
   pair=geo1$block, id=geo1$block, FECR="arithmetic",
...
al_fecr_ari_h1_unadj_geo1_j=format.epg.tmle(est.al.h1.geo1.ari)
hw_fecr_ari_h1_unadj_geo1_j=format.epg.tmle(est.hw.h1.geo1.ari)
tt_fecr_ari_h1_unadj_geo1_j=format.epg.tmle(est.tt.h1.geo1.ari)

rownames(al_fecr_ari_h1_unadj_geo1_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(hw_fecr_ari_h1_unadj_geo1_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(tt_fecr_ari_h1_unadj_geo1_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")

est.al.h1.geo1.geo=apply(matrix(trlist), 1,function(x) washb_tmle(Y=geo1$logalepg,tr=geo1$tr,
   pair=geo1$block, id=geo1$block, FECR="geometric",
   family="gaussian",contrast=c("Control",x),Q.SL.library=SL.library,
   g.SL.library=SL.library, pval=0.2, seed=12345, print=TRUE))
...
al_fecr_geo_h1_unadj_geo1_j=format.epg.tmle(est.al.h1.geo1.geo)
hw_fecr_geo_h1_unadj_geo1_j=format.epg.tmle(est.hw.h1.geo1.geo)
tt_fecr_geo_h1_unadj_geo1_j=format.epg.tmle(est.tt.h1.geo1.geo)

rownames(al_fecr_geo_h1_unadj_geo1_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(hw_fecr_geo_h1_unadj_geo1_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                             "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
...
al_fecr_ari_h1_unadj_geo0_j=format.epg.tmle(est.al.h1.geo0.ari)
hw_fecr_ari_h1_unadj_geo0_j=format.epg.tmle(est.hw.h1.geo0.ari)
tt_fecr_ari_h1_unadj_geo0_j=format.epg.tmle(est.tt.h1.geo0.ari)

rownames(al_fecr_ari_h1_unadj_geo0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(hw_fecr_ari_h1_unadj_geo0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(tt_fecr_ari_h1_unadj_geo0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")

est.al.h1.geo0.geo=apply(matrix(trlist), 1,function(x) washb_tmle(Y=geo0$logalepg,tr=geo0$tr,
   pair=geo0$block, id=geo0$block, FECR="geometric",
   family="gaussian",contrast=c("Control",x),Q.SL.library=SL.library,
   g.SL.library=SL.library, pval=0.2, seed=12345, print=TRUE))
...
al_fecr_geo_h1_unadj_geo0_j=format.epg.tmle(est.al.h1.geo0.geo)
hw_fecr_geo_h1_unadj_geo0_j=format.epg.tmle(est.hw.h1.geo0.geo)
tt_fecr_geo_h1_unadj_geo0_j=format.epg.tmle(est.tt.h1.geo0.geo)

rownames(al_fecr_geo_h1_unadj_geo0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                               "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(hw_fecr_geo_h1_unadj_geo0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                             "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")
rownames(tt_fecr_geo_h1_unadj_geo0_j)=c("Water vs C","Sanitation vs C","Handwashing vs C",
                             "WSH vs C","Nutrition vs C","Nutrition + WSH vs C")  
...
save(al_fecr_ari_h1_unadj_geo1_j,hw_fecr_ari_h1_unadj_geo1_j,tt_fecr_ari_h1_unadj_geo1_j,
     al_fecr_geo_h1_unadj_geo1_j,hw_fecr_geo_h1_unadj_geo1_j,tt_fecr_geo_h1_unadj_geo1_j,
