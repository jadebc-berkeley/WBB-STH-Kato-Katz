...
make.h1.bin.table=function(alprev,hwprev,ttprev,sthprev,
  ...
  unadjrd=c("",apply(alunadjrd,1,pt.est.ci.f,decimals,1),
            "",apply(hwunadjrd,1,pt.est.ci.f,decimals,1),
            "",apply(ttunadjrd,1,pt.est.ci.f,decimals,1),
            "",apply(sthunadjrd,1,pt.est.ci.f,decimals,1))
  
  adjrd=c("",apply(aladjrd,1,pt.est.ci.f,decimals,1),
          "",apply(hwadjrd,1,pt.est.ci.f,decimals,1),
          "",apply(ttadjrd,1,pt.est.ci.f,decimals,1),
          "",apply(sthadjrd,1,pt.est.ci.f,decimals,1))
  
  ipcwrd=c("",apply(alipcwrd,1,pt.est.ci.f,decimals,1),
           "",apply(hwipcwrd,1,pt.est.ci.f,decimals,1),
           "",apply(ttipcwrd,1,pt.est.ci.f,decimals,1),
           "",apply(sthipcwrd,1,pt.est.ci.f,decimals,1))
...
make.em.bin.table=function(prev,pr,
  ...
  sub=c("All","No","Yes","No","Yes","No","Yes","No","Yes","No","Yes","No","Yes","No","Yes","No","Yes","No","Yes","No","Yes","No","Yes")
  ...
  nall=rbind(n,ni0,ni1,npsac0,npsac1,npoor0,npoor1,ndw0,ndw1,ndef0,ndef1,nind0,nind1,nhmud0,nhmud1,nlmud0,nlmud1,nlat0,nlat1,nfec0,nfec1,nodf0,nodf1)
  prevall=rbind(mainprev,emprevi0,emprevi1,emprevpsac0,emprevpsac1,emprevpoor0,emprevpoor1,emprevdw0,emprevdw1,emprevdef0,emprevdef1,emprevind0,emprevind1,emprevhmud0,emprevhmud1,emprevlmud0,emprevlmud1,emprevlat0,emprevlat1,emprevfec0,emprevfec1,emprevodf0,emprevodf1)
  prall=rbind(mainpr,empri0,empri1,emprpsac0,emprpsac1,emprpoor0,emprpoor1,emprdw0,emprdw1,emprdef0,emprdef1,emprind0,emprind1,emprhmud0,emprhmud1,emprlmud0,emprlmud1,emprlat0,emprlat1,emprfec0,emprfec1,emprodf0,emprodf1)
...
make.em.epg.table=function(mn,gmn,fecr,
  ...
  nall=rbind(n,ni0,ni1,npsac0,npsac1,npoor0,npoor1,ndw0,ndw1,ndef0,ndef1,nind0,nind1,nhmud0,nhmud1,nlmud0,nlmud1,nlat0,nlat1,nfec0,nfec1,nodf0,nodf1)
  gmnall=rbind(maingmn,emgmni0,emgmni1,emgmnpsac0,emgmnpsac1,emgmnpoor0,emgmnpoor1,emgmndw0,emgmndw1,emgmndef0,emgmndef1,emgmnind0,emgmnind1,emgmnhmud0,emgmnhmud1,emgmnlmud0,emgmnlmud1,emgmnlat0,emgmnlat1,emgmnfec0,emgmnfec1,emgmnodf0,emgmnodf1)
  fecrall=rbind(mainfecr,emfecri0,emfecri1,emfecrpsac0,emfecrpsac1,emfecrpoor0,emfecrpoor1,emfecrdw0,emfecrdw1,emfecrdef0,emfecrdef1,emfecrind0,emfecrind1,emfecrhmud0,emfecrhmud1,emfecrlmud0,emfecrlmud1,emfecrlat0,emfecrlat1,emfecrfec0,emfecrfec1,emfecrodf0,emfecrodf1)
