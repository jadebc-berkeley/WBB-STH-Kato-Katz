...
#---------------------------------------------
# Subset to index children
#---------------------------------------------
load(paste0(save_data_path,"sth_pr_unadj_index.RData"))
load(paste0(save_data_path, "sth_pr_epg_unadj_index.RData"))
...
index.table=make.index.table.csv(al_prev,hw_prev,tt_prev,sth_prev,
                             ...
                             al_rr_h1_unadj_tmle_j,hw_rr_h1_unadj_tmle_j,tt_rr_h1_unadj_tmle_j,sth_rr_h1_unadj_tmle_j,
                             al_rr_h1_unadj_i1_j,hw_rr_h1_unadj_i1_j,tt_rr_h1_unadj_i1_j,sth_rr_h1_unadj_i1_j, 
